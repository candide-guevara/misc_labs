...
void* vanilla_tcp_clt(void * to_addr) {
  ...
  LOG_INFO("CLIENT Connection (type=%d, port=%d, addr=%s) <=> (type=%d, port=%d, addr=%s)", 
...
int main (void) {
  ...
  try_6_4_combi("0.0.0.0", "127.0.0.1", "::", "::1", NULL);
  ...
  try_6_4_combi("192.168.43.139", "192.168.43.139", "2a00:1450:4001:815::200e", "2a00:1450:4001:815::200e", extra_sockopt);
