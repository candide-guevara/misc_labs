...
#define CHRONOID_ENUM(XX)                \
  ...
  XX(DESTRUCT_PTR_REVERSAL_DAG),         \
  XX(DESTRUCT_PTR_REVERSAL_DCYCLE),      \
  XX(DESTRUCT_PTR_REVERSAL_UCYCLE),      \
  XX(PTR_REVERSAL_DAG),                  \
  XX(PTR_REVERSAL_DCYCLE),               \
  XX(PTR_REVERSAL_UCYCLE),               \
  XX(DESTRUCT_BACK_FORTH_DAG),           \
  XX(DESTRUCT_BACK_FORTH_DCYCLE),        \
  XX(DESTRUCT_BACK_FORTH_UCYCLE),        \
  XX(STD_DEPTH_FIRST_DAG),               \
  XX(STD_DEPTH_FIRST_DCYCLE),            \
  XX(STD_DEPTH_FIRST_UCYCLE),            \
  XX(__CHRONO_LAST__),
